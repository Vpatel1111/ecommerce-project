...
<!-- Sidebar end=============================================== -->
	...
	<div class="control-group">
		...
		<div class="control-group">
			<div class="controls">
				<input class="btn btn-large btn-success" type="submit" name="action" value="Login" />
				<a href="forgot_password.jsp"><input class="btn btn-large btn-primary" type="button" name="action" value="Forgot Password" /></a>
			</div>
		</div>		
	</form>
		</div>
