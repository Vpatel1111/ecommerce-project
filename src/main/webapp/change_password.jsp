						...
						<div class="span8">
							...
							<form class="form-horizontal" method="post"
								...
								<div class="control-group">
									<label class="control-label" for="inputPassword1">Old Password
										<sup>*</sup>
									</label>
									<div class="controls">
								...
								<div class="control-group">
									<label class="control-label" for="inputPassword1">New Password
										<sup>*</sup>
									</label>
									<div class="controls">
										<input type="password" id="inputPassword1"
								...
								<div class="control-group">
									<label class="control-label" for="inputPassword1">Confirm New Password
										<sup>*</sup>
									</label>
									<div class="controls">
										<input type="password" id="inputPassword1"
