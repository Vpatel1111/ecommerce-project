	...
	<div class="row">
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
					<a  href="product_details.jsp"><img src="product_images/<%=p.getProduct_image() %>" alt=""/></a>
					<div class="caption">
					  ...
					  <h4 style="text-align:center">
					  	<a class="btn btn-primary" href="seller_product_edit.jsp?pid=<%=p.getId()%>"> EDIT</a> 
					  	
					  	<a class="btn btn-danger" href="seller_product_delete.jsp?pid=<%=p.getId()%>">DELETE</a>
					  </h4>
					</div>
				  </div>
				</li>
